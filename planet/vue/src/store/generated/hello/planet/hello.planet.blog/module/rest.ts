...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/hello/planet/blog/post
   */
  queryPostAll = (
    query?: {
   ...
   * @request GET:/hello/planet/blog/sentPost
   */
  querySentPostAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryAllSentPostResponse, RpcStatus>({
      path: `/hello/planet/blog/sentPost`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/hello/planet/blog/timedoutPost
   */
  queryTimedoutPostAll = (
    ...
    this.request<BlogQueryAllTimedoutPostResponse, RpcStatus>({
      path: `/hello/planet/blog/timedoutPost`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
