...
export const protobufPackage = 'hello.planet.blog';
...
export const QueryAllTimedoutPostRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllTimedoutPostRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const QueryAllTimedoutPostResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllTimedoutPostResponse };
...
export class QueryClientImpl {
    ...
    TimedoutPost(request) {
        ...
        const promise = this.rpc.request('hello.planet.blog.Query', 'TimedoutPost', data);
    ...
    TimedoutPostAll(request) {
        ...
        const promise = this.rpc.request('hello.planet.blog.Query', 'TimedoutPostAll', data);
    ...
    SentPost(request) {
        ...
        const promise = this.rpc.request('hello.planet.blog.Query', 'SentPost', data);
    ...
    SentPostAll(request) {
        ...
        const promise = this.rpc.request('hello.planet.blog.Query', 'SentPostAll', data);
    ...
    Post(request) {
        ...
        const promise = this.rpc.request('hello.planet.blog.Query', 'Post', data);
        return promise.then((data) => QueryGetPostResponse.decode(new Reader(data)));
    }
    PostAll(request) {
        const data = QueryAllPostRequest.encode(request).finish();
        const promise = this.rpc.request('hello.planet.blog.Query', 'PostAll', data);
