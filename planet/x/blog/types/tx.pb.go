...
func init() {
	proto.RegisterType((*MsgSendIbcPost)(nil), "hello.planet.blog.MsgSendIbcPost")
	proto.RegisterType((*MsgSendIbcPostResponse)(nil), "hello.planet.blog.MsgSendIbcPostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	,
}
...
func (c *msgClient) SendIbcPost(ctx context.Context, in *MsgSendIbcPost, opts ...grpc.CallOption) (*MsgSendIbcPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hello.planet.blog.Msg/SendIbcPost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SendIbcPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.planet.blog.Msg/SendIbcPost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "hello.planet.blog.Msg",
